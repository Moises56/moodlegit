...
info "Granting write privileges to Moodle directories for the 'bitnami' user"
configure_permissions_ownership "$MOODLE_BASE_DIR" -u "bitnami" -g "$WEB_SERVER_DAEMON_USER"
